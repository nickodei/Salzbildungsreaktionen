...
namespace Salzbildungsreaktionen_Core.Reaktionen
{
    public class MetalloxidSaeureReaktionsResultat
    {
        ...
        private Reaktionsstoff<Verbindung> _Wasser;
        public Reaktionsstoff<Verbindung> Wasser
        {
            get { return _Wasser; }
            set { _Wasser = value; }
        }

        public MetalloxidSaeureReaktionsResultat(Reaktionsstoff<Metalloxid> metalloxid, Reaktionsstoff<Saeure> saeure, Reaktionsstoff<Salz<Metall, Verbindung>> salz, Reaktionsstoff<Verbindung> wasser)
        {
